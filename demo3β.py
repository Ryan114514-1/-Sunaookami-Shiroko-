...
# ==================== 配置 ====================
DEEPSEEK_KEY_REASONER = os.getenv("DEEPSEEK_KEY_REASONER", "sk-4377abb0b4bbb204595b")
DEEPSEEK_KEY_MEMORY   = os.getenv("DEEPSEEK_KEY_MEMORY", "sk-d8580ec65d9766")
DEEPSEEK_KEY_EMOTION  = os.getenv("DEEPSEEK_KEY_EMOTION", "sk-7464415d65c20b8be200f3ac")
DEEPSEEK_KEY_LANGUAGE = os.getenv("DEEPSEEK_KEY_LANGUAGE", "sk-808f6d9b03c5158e20d6")
